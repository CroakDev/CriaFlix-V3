...
import { ChevronDownIcon, Home, ListVideo, HeartHandshake, Flame, Play, Compass, User, Heart } from "lucide-react";
...
export function SidebarMenu() {
            ...
            submenu: [
                {
                    ...
                    href: "/home/playlist/1",
                },
                {
                    name: "Playlist 2",
                    icon: <ListVideo size={15} className="mr-2" />,
                    href: "/home/playlist/2",
                },
                {
                    name: "Playlist 3",
                    icon: <ListVideo size={15} className="mr-2" />,
                    href: "/home/playlist/3",
                },
            ],
        },
        {
    ...
    return (
        <div className="fixed left-0 top-0 h-screen w-48 bg-background z-50 border-r-[1px] border-gray-500/10 flex flex-col justify-between">
            ...
            {!isVip ? (
                ...
                <div className="p-4 bg-secondary m-4 rounded-lg text-center">
                    <p className="text-xs text-slate-600 dark:text-slate-300 ">You are a VIP member! Enjoy your exclusive perks!</p>
                </div>
            )}
