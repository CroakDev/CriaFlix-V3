...
export default function MediaDetailPage({ params }: { params: { id: string } }) {
    ...
    const serverData = media
        ? {
            ...
            servers: [
                { id: 'server1', name: 'SuperFlix', url: `https://superflixapi.asia/filme/${media.externalIds.imdb_id}#colorA36AF9#noLink`, country: 'BR', premium: false },
                ...
                <div className="lg:col-span-2 xl:col-span-3">
                    ...
                    <div className="flex flex-wrap items-center justify-between ">
                        <p className="text-gray-500 text-sm">
                            ...
                            {(media.release_date || media.first_air_date)
                                ? formatDistanceToNow(new Date(media.release_date || media.first_air_date as string), { locale: ptBR, addSuffix: true })
                                : 'Data não disponível'}
                                </span>
                        </p>
                    ...
                    {mediaType === 'tv' ? (
                        <div className="mt-8 bg-secondary rounded-lg p-4">
                            ...
                            <div className="space-y-2">
                                {[1, 2, 3, 4, 5].map((index) => (
                                    <div key={index} className="flex items-center space-x-3 p-2 hover:bg-background rounded-md cursor-pointer">
                                        ...
                                        <div>
                                            <p className="font-medium">Episode {index}: {index === 1 ? "Big Buck Bunny" : `Animated Short ${index}`}<br />
                                                <span className="text-sm text-zinc-500">When a deliciously wicked prank gets Wednesday expelled, her parents ship her off to Nevermore Academy, the boarding school where they fell in love.</span>
                                            </p>

                                            <Badge className="bg-background text-zinc-950 dark:text-gray-500 rounded-sm hover:bg-background">13:30</Badge>
                    ...
                    <div className="mt-8">
                        ...
                        <div className="flex space-x-4 mt-4">
                            ...
                            <div>
                                <h4 className="font-semibold">CriaFlix Group <span className="bg-primary rounded text-[11px] text-background p-[4px]">Admin</span></h4> 
